...
def aruco_display(corners, ids, image, slot_timers, slot_occupancy, slot_records, final_time_list, slot_counters):
    if len(corners) > 0:
...
while cap.isOpened():
    ...
    if len(corners) > 0:
        detected_markers, updated_slots, updated_occupancy, final_time_list = aruco_display(corners, ids, img, slot_timers, slot_occupancy, slot_records, final_time_list, slot_counters)  # Pass slot_counters as an argument
    ...
    if current_time - last_print_time >= print_interval:
        ...
        for i in range(5):
            ...
            print(f"Slot {i + 1} Counter:", slot_counters[i])  # Print the updated slot counter
